...
l1Menus= {
    ...
    'FULL'         : ( ','.join( [ 'L1Menu_Collisions2016_v7_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-09-23 05:50:52.000"] ), ),
    'GRun'         : ( ','.join( [ 'L1Menu_Collisions2016_v7_xml'                            ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-09-23 05:50:52.000"] ), ),
    ...
    'PIon'         : ( ','.join( [ 'L1Menu_HeavyIons2016_v0_xml'                             ,l1tMenuRecord,connectionString,l1tMenuLabel, "2016-08-19 08:40:00.000"] ), ),
